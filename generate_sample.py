...
def fixdate(x,pos): #convert date into integer
...
pos = pd.read_csv('/home/mattliston/ad/pos.csv',header=0) #use your own path
pos = pos.as_matrix()
...
n=0
count=1
for chunk in pd.read_csv('/home/mattliston/ad/neg.csv', chunksize=chunksize):  #use your own path
...
neg.to_csv('neg_sample.csv',index=False,header=False)
